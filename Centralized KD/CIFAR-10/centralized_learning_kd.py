...
# Normalize data (CIFAR-10 is already in the correct shape, so just normalize)
...
pyplot.title('Centralized KD: Training and Validation Accuracy Over Epochs on CIFAR-10 Dataset')
...
pyplot.savefig('Centralized KD:  Training and Validation Accuracy Over Epochs on CIFAR-10 Dataset.png')
pyplot.legend()
pyplot.show()
...
# Plot training and validation loss using seaborn
pyplot.figure(figsize=(10, 6))
pyplot.title('Centralized KD: Training and Validation Loss Over Epochs on CIFAR-10 Dataset')
pyplot.ylabel('Loss')
pyplot.xlabel('Epoch')
pyplot.plot(history.history['loss'], label='train')
pyplot.plot(history.history['val_loss'], label='test')
pyplot.savefig('Centralized KD: Training and Validation Loss Over Epochs on CIFAR-10 Dataset.png')
pyplot.legend()
pyplot.show()
...
output_path = "Centralized KD Training and Validation Accuracy Over Epochs on CIFAR-10 Dataset.csv"
...
# Save DataFrame as CSV
output_path = "Centralized KD Training and Validation Loss Over Epochs on CIFAR-10 Dataset.csv"
