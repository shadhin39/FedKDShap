...
def plot_training_accuracy():
    if train_accuracies:
        ...
        plt.title(f'FL+KD: FMNIST Dataset, Training Accuracy of Client {client_id} Over Rounds', fontsize=16)
...
output_path = "FL_KD FMNIST Dataset, Training Accuracy of Client 0 Over Rounds.csv"
