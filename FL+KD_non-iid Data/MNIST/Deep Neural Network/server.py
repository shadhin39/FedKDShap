...
def plot_accuracies():
    ...
    plt.title("Global Model Evaluation Accuracies for FL+KD Over Rounds on MNIST Dataset", fontsize=16, fontweight='bold')
...
def plot_losses():
    ...
    plt.title("Global Model Evaluation Losses for FL+KD Over Rounds on MNIST Dataset", fontsize=16, fontweight='bold')
    plt.xlabel("Federated Learning Round", fontsize=14)
...
output_path = "Global Model Evaluation Accuracies and Losses for FL_KD Over Rounds on MNIST Dataset.csv"
