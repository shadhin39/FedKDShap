...
def plot_training_accuracy():
    if train_accuracies:
        ...
        plt.title(f'FL+KD+SHAP: MNIST Dataset, Training Accuracy of Client {client_id} Over Rounds', fontsize=16)
...
output_path = "FL_KD_SHAP MNIST Dataset, Training Accuracy of Client 2 Over Rounds.csv"
