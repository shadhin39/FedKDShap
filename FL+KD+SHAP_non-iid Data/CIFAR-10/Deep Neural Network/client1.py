...
def create_student_model():
    model = keras.Sequential([
        keras.Input(shape=(32, 32, 3)),  # CIFAR-10 input shape
...
# Assume x_train, y_train, x_test, y_test come from some data loading mechanism
...
# Assume calculate_feature_importance returns some feature importance vector
...
def plot_training_accuracy():
    if train_accuracies:
        ...
        plt.title(f'FL+KD+SHAP: CIFAR-10 Dataset, Training Accuracy of Client {client_id} Over Rounds', fontsize=16)
...
output_path = "FL_KD_SHAP CIFAR-10 Dataset, Training Accuracy of Client 1 Over Rounds.csv"
