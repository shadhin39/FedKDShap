...
def plot_accuracies():
    ...
    plt.title("Global Model Evaluation Accuracies for FL+KD+SHAP Over Rounds on CIFAR-10 Dataset", fontsize=16, fontweight='bold')
...
def plot_losses():
    ...
    plt.title("Global Model Evaluation Losses for FL+KD+SHAP Over Rounds on CIFAR-10", fontsize=16, fontweight='bold')
    plt.xlabel("Federated Learning Round", fontsize=14)
...
df = pd.DataFrame({
    "Accuracy": accuraciess,
    "Loss": losses
})

# Save DataFrame as CSV
output_path = "Global Model Evaluation Accuracy and Losses for FL_KD_SHAP Over Rounds on CIFAR-10.csv"
