...
# print("Feature Importance:")
# for feature, importance in zip(x_train.shape[1], feature_importance):
...
def plot_training_accuracy():
    if train_accuracies:
        ...
        plt.title(f'FL+KD+SHAP: FMNIST Dataset, Training Accuracy of Client {client_id} Over Rounds', fontsize=16)
...
output_path = "FL_KD_SHAP FMNIST Dataset, Training Accuracy of Client 0 Over Rounds.csv"
